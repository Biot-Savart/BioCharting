...
var defs;
var arcGroup;
function drawPie(data, divId, width, height) {
    ...
    addPie(pieData, divId, width, height);
}




function addPie(data, divId, width, height)
{
    width = width || 360;
    height = height || 360;
  ...
  .attr('transform', function (d, i) {
      ...
      var horz = legendRectSize + width/2 - 20;
      var vert = i * h - width/2;
